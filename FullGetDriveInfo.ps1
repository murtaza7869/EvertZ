...
<#
.SYNOPSIS
    SSD / Physical Drive Information Collector
.DESCRIPTION
    Without arguments : runs quick mode (Physical Disks, Partition Layout, Volume Health)
    With -Full        : runs all 10 sections including SMART, error events, pagefile, etc.
.PARAMETER Full
    Switch to enable full diagnostics mode.
.EXAMPLE
    .\Get-DriveInfo.ps1
    .\Get-DriveInfo.ps1 -Full
.NOTES
...
$OutputFile = "$PSScriptRoot\DriveReport_${Mode}_$(hostname)_$(Get-Date -Format 'yyyyMMdd_HHmmss').txt"
...
# Header
# ---------------------------------------------------------------------------
$Report.Add("DRIVE DIAGNOSTIC REPORT  [$Mode mode]")
$Report.Add("Generated : $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')")
$Report.Add("Hostname  : $(hostname)")
$Report.Add("User      : $env:USERNAME")
Write-Host ""
Write-Host "DRIVE DIAGNOSTIC REPORT -- $(hostname)  [$Mode mode]" -ForegroundColor Yellow
Write-Host "Generated : $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')" -ForegroundColor Gray
if (-not $Full) {
    Write-Host "  Tip: run with -Full for SMART data, error events, pagefile and RAM info." -ForegroundColor DarkGray
}
Write-Host ""

# ===========================================================================
# SECTION 1 -- Physical Disk Summary  (always runs)
# ===========================================================================
...
# ===========================================================================
# SECTION 2 -- Disk and Partition Layout  (always runs)
# ===========================================================================
...
# ===========================================================================
# SECTION 3 -- SMART Status  (Full only)
# ===========================================================================
if ($Full) {
...
# ===========================================================================
# SECTION 4 -- SMART Raw Attributes  (Full only)
# ===========================================================================
if ($Full) {
...
# ===========================================================================
# SECTION 5 -- NVMe Health  (Full only)
# ===========================================================================
if ($Full) {
...
# ===========================================================================
# SECTION 6 -- Volume Health and Free Space  (always runs)
# ===========================================================================
...
# ===========================================================================
# SECTION 7 -- Disk Error Events  (Full only)
# ===========================================================================
if ($Full) {
...
# ===========================================================================
# SECTION 8 -- chkdsk Status  (Full only)
# ===========================================================================
if ($Full) {
...
# ===========================================================================
# SECTION 9 -- Pagefile and CrashControl  (Full only)
# ===========================================================================
if ($Full) {
...
# ===========================================================================
# SECTION 10 -- System RAM  (Full only)
# ===========================================================================
if ($Full) {
...
# Save report
# ---------------------------------------------------------------------------
Write-Section "REPORT COMPLETE  [$Mode mode]"
...
if ($Full) {
    ...
    Add-Line ""
    Add-Line "  Run with -Full for SMART attributes, error events, pagefile and RAM info." "DarkGray"
}
